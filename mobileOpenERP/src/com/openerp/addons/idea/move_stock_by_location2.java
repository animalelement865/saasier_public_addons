...
public class move_stock_by_location2 extends BaseFragment {
	View mView;
	SeekBar seekBar;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		int totalqty=(int)OEHelper.sourcetotalqty;
		String tqty=totalqty+"";
		if(tqty.length()>4)
		{
			//tv_selected_qty.setText(""+Product_Detail.selected_qty.substring(0,4)+" "+Product_Detail.selected_uom);
			tv_selected_qty.setText(""+tqty.substring(0,4)+" "+Product_Detail.selected_uom);
		}
		else
		{
			tv_selected_qty.setText(""+tqty+" "+Product_Detail.selected_uom);
		}
		
	//	Toast.makeText(getActivity(), "qty"+tqty, 20).show();
	...
	//	String qty = Product_Detail.selected_qty;
		...
		moveqty.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Toast.makeText(getActivity(), "source loc ="+OEHelper.selectedsourceid+"   "+transferstock, 40).show();
				...
				val.put("location_id", OEHelper.selectedsourceid);
				// val.put("type","out");
				val.put("state", "done");
