...
//		hour_plus.setBackgroundDrawable(gd);
//		hour_display.setBackgroundDrawable(gd);
//		hour_minus.setBackgroundDrawable(gd);
//		min_plus.setBackgroundDrawable(gd);
//		min_display.setBackgroundDrawable(gd);
//		min_minus.setBackgroundDrawable(gd);
//		am_pm.setBackgroundDrawable(gd);
	...
	private void initData() {
		...
		if (currentTimeFormate == HOUR_12) {
			...
			Log.d("initial yes display"
					+ (String.valueOf(cal.get(Calendar.HOUR))), "ok");
			sendToDisplay();
		} else {
			Log.d("initial no display"
					+ (String.valueOf(cal.get(Calendar.HOUR))), "ok");
	...
	private void sendToDisplay() {
		// String temp=String.valueOf(cal.get(Calendar.HOUR));
		if (currentTimeFormate == HOUR_12) {

			if (String.valueOf(cal.get(Calendar.HOUR)).equals("12")) {
		...
		// Log.e("check ampm="+Calendar.AM, "ok..,,,");
		if (isAMPMVisible) {
			if (cal.get(Calendar.AM_PM) == Calendar.AM) {
				// Log.e("check ampm="+cal.get(Calendar.AM_PM), "ok..,,,");
				am_pm.setText("AM");
			} else {
				Log.e("pM", "ok..,,,");
				am_pm.setText("PM");
