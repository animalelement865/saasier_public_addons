...
public class QR_scan_for_insert_product_to_consume extends BaseFragment implements
		ScanditSDKListener {
...
//				Toast.LENGTH_LONG).show();
		...
		//	dialog.dismiss();
			...
			product_to_consume p_c=new product_to_consume();
