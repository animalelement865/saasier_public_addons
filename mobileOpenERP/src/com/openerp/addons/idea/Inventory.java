...
public class Inventory extends BaseFragment implements OnItemClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		movesock.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				{
					Toast.makeText(getActivity(), "Wait..", 6).show();
				}
				else
				{
		...
		runnable = new Runnable() {
			...
			private int performTask() {
				...
				oehelper1.releted_selected_stock_location_id();
				oehelper1.main_for_get_available_qty();
				return ++myProgress;
			}
		};
