...
public class QR_scan_for_dest_loc_trasfer_qty extends BaseFragment implements ScanditSDKListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		getActivity().setTitle(R.string.label_qr_scan_destination);
...
//	}
	...
	//	Toast.makeText(getActivity(), "QR Code = "+cleanedBarcode, 30).show();
		...
		{
			Toast.makeText(getActivity(), "LOCATION NOT MATCHED ",
					Toast.LENGTH_LONG).show();
		}
