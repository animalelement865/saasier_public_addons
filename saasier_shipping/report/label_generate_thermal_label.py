...
import urllib
import base64
class label_generate_thermal_label(report_sxw.rml_parse):
    
    
    def __init__(self, cr, uid, name, context):
        super(label_generate_thermal_label, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.label.generate.thermal.label','stock.picking.out.label','addons/shipping_saasier/report/label_generate_thermal_label.rml',parser=label_generate_thermal_label)
